...
inline const std::array<ColorPalette, 10>& getPalettes()
{
    static const std::array<ColorPalette, 10> palettes = {{
        ...
        // 2. Chic Monochrome
        {
            ...
            juce::Colour(0xffdddddd), juce::Colour(0xffbbbbbb), juce::Colour(0xff999999), juce::Colour(0xff777777)
        },
        // 3. Vivid Future
        {
            "Vivid Future",
        ...
        // 6. Cyberpunk
        {
            ...
            juce::Colour(0xfffcee0a), juce::Colour(0xffff0055), juce::Colour(0xffb500ff), juce::Colour(0xff00f0ff)
        },
        // 7. Ocean Abyss
        {
            "Ocean Abyss",
        ...
        // 8. Forest Zenith
        {
            ...
            juce::Colour(0xffa1887f),
            juce::Colour(0xff4caf50), juce::Colour(0xff8bc34a), juce::Colour(0xffcddc39), juce::Colour(0xffa1887f)
        },
        // 9. Sunset Glow
        {
            "Sunset Glow",
        ...
        // 10. Midnight Gold
        {
            ...
            juce::Colour(0xffffffff),
            juce::Colour(0xffd4af37), juce::Colour(0xffaa7c11), juce::Colour(0xffebd185), juce::Colour(0xffffffff)
        }
    }};
    return palettes;
}
